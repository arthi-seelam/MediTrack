              ...
              {hospital && (
                <>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <a href={`tel:${hospital.phone}`} className="text-sm text-primary hover:underline">{hospital.phone}</a>
                  </div>
                </>
              )}
            </div>
            ...
            <div className="flex items-start justify-between">
              <div>
                ...
                <div className="flex items-center gap-4 mt-2 text-sm">
                  ...
                  <span className={`px-2 py-0.5 rounded-full text-xs font-medium ${hospital.is24x7 ? "bg-success/10 text-success" : "bg-warning/10 text-warning"}`}>
                    {hospital.is24x7 ? "24×7" : "Regular Hours"}
                  </span>
                </div>
              </div>
              <Link to={`/hospitals/${hospital.id}`} className="px-4 py-2 rounded-lg bg-muted text-muted-foreground hover:bg-muted/80 text-sm font-medium transition-colors">
                View Hospital
              </Link>
            </div>
          </div>
